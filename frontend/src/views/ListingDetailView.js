                  ...
                  <div className="p-6 sm:p-8 flex flex-col">
                        ...
                        {listing.pickup_type && (
                          <div className="mb-3">
                            ...
                            <span className="text-sm font-medium text-gray-900">
                              {listing.pickup_type === "owner_meetup" && "Meet with owner"}
                              {listing.pickup_type === "curbside" && "Curbside pickup"}
                              {listing.pickup_type === "street_find" && "Street location"}
                            </span>
                          </div>
                        )}
                    ...
                    <div className="pt-6">
                      {listing.user_request ? (
                          ...
                          <div className="rounded-xl border border-blue-200 bg-blue-50 p-5">
                            <div className="flex items-start justify-between mb-3">
                              <div>
                                ...
                                >
                                  {listing.user_request.status.charAt(0).toUpperCase() +
                                    listing.user_request.status.slice(1)}
                                </span>
                              </div>
                              <span className="text-xs text-gray-500">
                                {new Date(listing.user_request.created_at).toLocaleDateString(
                                  "en-US",
                                  {
                                    month: "short",
                                    day: "numeric",
                        ...
                        // User has not requested this item yet
                        <div>
                          <h2 className="text-lg font-semibold text-gray-900 mb-3">
                            Request This Item
                          </h2>
